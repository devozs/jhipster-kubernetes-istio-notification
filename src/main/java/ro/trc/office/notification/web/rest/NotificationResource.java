...
import ro.trc.office.notification.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link ro.trc.office.notification.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
